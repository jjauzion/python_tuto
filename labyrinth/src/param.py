...
def     str_usage():
    ...
    str += "\nCommandes de jeu:\n"
    str += "  --> '{}{}' + 'nb_de_case' : Aller 'nb_de_cases' vers le nord (ex: #n3)\n".format(command_char, command_list[0])
    ...
    str += "  --> '{}{}' + 'direction' : Murer la porte (ex: #ms pour murer la porte situé au sud de votre position\n".format(command_char, command_list[4])
    str += "  --> '{}{}' + 'direction' : Percer le mur (ex: #ps pour percer le mur situé au sud de votre position\n".format(command_char, command_list[5])
    str += "\nCommandes serveur:\n"
